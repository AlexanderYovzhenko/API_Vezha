...
const controller_cu_1 = __importDefault(require("./schema/controller.cu"));
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, schema: controller_cu_1.default }),
    (0, swagger_1.ApiParam)({ name: 'boardId', description: 'ID Board' }),
    (0, swagger_1.ApiParam)({ name: 'columnId', description: 'ID Column' }),
    (0, common_1.Post)(),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, schema: controller_cu_1.default }),
    (0, swagger_1.ApiParam)({ name: 'boardId', description: 'ID Board' }),
    (0, swagger_1.ApiParam)({ name: 'columnId', description: 'ID Column' }),
    (0, swagger_1.ApiParam)({ name: 'taskId', description: 'ID Task' }),
